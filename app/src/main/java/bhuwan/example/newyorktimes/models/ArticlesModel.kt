package bhuwan.example.newyorktimes.models
...
data class Doc (
    ...
    val newsDesk: NewsDesk? = null,
    val sectionName: SectionName? = null,
    val subsectionName: SubsectionName? = null,
